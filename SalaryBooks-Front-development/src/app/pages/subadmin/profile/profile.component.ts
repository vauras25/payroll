...
@Component({
  selector: 'subadmin-app-profile',
  templateUrl: './profile.component.html',
  styleUrls: ['./profile.component.css']
})
export class SADProfileComponent implements OnInit {
  BACKEND_URL: any;
  ...
  updateBaicDetails(event: any) {
    if (this.basicDetailsForm.valid) {
      ...
      this.subadminService.updateAccountData({
  ...
  updateAccountPassword(event: any) {
    if (this.passwordUpdateForm.valid) {
      ...
      this.subadminService.updateAccountPassword({
