...
@Component({
  selector: 'admin-app-leave-rule',
  templateUrl: './leave-rule.component.html',
  styleUrls: ['./leave-rule.component.css']
})
export class ADLeaveRuleComponent implements OnInit {
  ...
  fetchLeaveHeads() {
    ...
    return new Promise((resolve, reject) => {
      _this.spinner.show();
      _this.adminService.fetchLeaveTemplateHeads({})
        .subscribe(res => {
  ...
  getEdit(item: any) {
    ...
    item.template_data.forEach((element: any) => {
      let data: any = {
  ...
  add(event: any) {
    ...
    if (this.leaveRuleForm.valid && template_data) {
      ...
      this.adminService.createLeaveTemplateRule({
  ...
  edit(event: any) {
    ...
    if (this.leaveRuleForm.valid && template_data) {
      ...
      this.adminService.updateLeaveTemplateRule({
  ...
  fetch(page: any = null) {
    ...
    this.spinner.show();
    this.adminService.fetchLeaveTemplateRules({
  ...
  deleteItem(item: any) {
    swal.fire({
      ...
      if (result.value) {
        this.adminService.deleteLeaveTemplateRule({
  ...
  submitLeaveHead(event: any) {
    ...
    if (this.leaveHeadForm.valid) {
      ...
      this.adminService.createLeaveTemplateHead({
  ...
  changeLeaveTypePublishStatus(item: any) {
    this.spinner.show();
    this.adminService.updateLeaveTemplateRulePublishStatus({
      'template_id': item._id,
