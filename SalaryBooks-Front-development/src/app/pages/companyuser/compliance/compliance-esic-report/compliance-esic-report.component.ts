...
@Component({
  selector: 'app-compliance-esic-report',
  templateUrl: './compliance-esic-report.component.html',
  styleUrls: ['./compliance-esic-report.component.css'],
})
export class CMPComplianceEsicReportComponent implements OnInit {
  Global = Global;
