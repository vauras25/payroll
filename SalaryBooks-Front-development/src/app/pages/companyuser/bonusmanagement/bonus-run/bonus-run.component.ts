...
@Component({
    selector: 'app-companyuser-bonus-run',
    templateUrl: './bonus-run.component.html',
    styleUrls: ['./bonus-run.component.css']
})
export class CMPBonusRunComponent implements OnInit {
    Global = Global;
    employees: any[] = [];
    ...
    fetchEmployees({
        ...
        return new Promise((resolve, reject) => {
            ...
            this.companyuserService.getBonusFormMonthly(payload).subscribe(res => {
    ...
    async generateReport() {
        return new Promise((resolve, reject) => {
            ...
            this.spinner.show();
            this.companyuserService.runBonusSheet({
