...
@Component({
  selector: 'pf-summary-report',
  templateUrl: './pf-summary-report.component.html',
  styleUrls: ['./pf-summary-report.component.css']
})
export class CMPPfSummaryReportComponent implements OnInit {
  ...
  getDaysDiffFromDates(startDate:any, endDate:any){
    ...
    return endDate.diff(startDate, 'days') < 0?0:endDate.diff(startDate, 'days');
  }
