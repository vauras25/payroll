...
@Component({
  selector: 'app-month-wise-summary',
  templateUrl: './month-wise-summary.component.html',
  styleUrls: ['./month-wise-summary.component.css']
})
export class MonthWiseSummaryComponent implements OnInit {
