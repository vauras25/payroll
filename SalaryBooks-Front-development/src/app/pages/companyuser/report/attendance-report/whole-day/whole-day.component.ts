...
@Component({
  selector: 'app-whole-day',
  templateUrl: './whole-day.component.html',
  styleUrls: ['./whole-day.component.css']
})
export class WholeDayComponent implements OnInit {
                  ...
                  if(item==undefined)
                   {
                    ...
                    item.attendance_stat=item.attendance_stat??'N/A';
