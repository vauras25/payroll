...
@Component({
    selector: 'app-companyuser-overtime-run',
    templateUrl: './overtime-run.component.html',
    styleUrls: ['./overtime-run.component.css']
})
export class CMPOvertimeRunComponent implements OnInit {
    Global = Global;
    employees: any[] = [];
    ...
    ngOnInit() {
        this.titleService.setTitle("Run Overtime - " + Global.AppName);
        this.spinner.show();
    }
    ...
    fetchEmployees({
        ...
        return new Promise((resolve, reject) => {
            ...
            this.companyuserService.getOvertimeEmployeeList(payload).subscribe(res => {
    ...
    async generateReport() {
        return new Promise((resolve, reject) => {
            ...
            this.spinner.show();
            this.companyuserService.runOvertimeSheet({
