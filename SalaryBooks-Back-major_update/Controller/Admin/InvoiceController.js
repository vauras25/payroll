var Invoice = require('../../Model/Admin/Invoice');
...
module.exports = {
    ...
    add_invoice_data: async function (req, resp, next) {
        try{
            const v = new Validator(req.body, {
                company_address: 'required',
                bank_name:'required|in:default,customizable,na',
                bank_account:'required|in:default,customizable,na',
                bank_ifsc:'required|in:default,customizable,na',
                bank_branch:'required',
                hsn_sac:'required',
                gst_tax_rate:'required',
                digi_signature:'required',
                invoice_note:'required',
                company_gstin_uin:'required',
                pan_no:'required',
            });
